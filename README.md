...
- **Nearly no runtime errors** - Elchemy's type system **eliminates almost all runtime errors**. With a shrinking set of edge cases, your entire app is safe. The integrated, dynamically typed Elixir code can cause such rare edge cases.
