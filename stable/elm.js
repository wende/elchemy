...
var _user$project$Helpers$toSnakeCase = F2(
	function (isntAtom, s) {
		var string = isntAtom ? _user$project$ExReserved$maybeReplaceReserved(s) : s;
		return _elm_lang$core$Native_Utils.eq(
				...
				if (((_p3._0.ctor === 'TypeConstructor') && (_p3._0._0.ctor === '::')) && (_p3._0._0._1.ctor === '[]')) {
					...
					return A3(
						...
						A5(
							...
							_p7,
							A3(_user$project$ExAlias$replaceAliasArgs, _p9, _p8, _p7)),
						ls);
				} else {
					return _elm_lang$core$Native_Utils.crashCase(
						'ExAlias',
		...
		return A2(
			...
			A2(
				...
				function (_p31) {
					var _p32 = _p31;
					var _p34 = _p32.mod;
					var _p33 = _p32.getTypeBody;
					return _elm_lang$core$Native_Utils.eq(_p34, c.mod) ? A2(
...
var _user$project$ExType$typeRecordFields = F3(
	function (c, flatten, t) {
		...
		_v17_4:
		do {
			if (_p35.ctor === 'TypeRecordConstructor') {
				switch (_p35._0.ctor) {
					case 'TypeConstructor':
						if ((_p35._0._0.ctor === '::') && (_p35._0._0._1.ctor === '[]')) {
							var inherited = A2(
								_elm_lang$core$Maybe$map,
								...
								A2(
									...
									function (_p36) {
										var _p37 = _p36;
										return _p37.getTypeBody(_p35._0._1);
									},
									A2(_user$project$ExAlias$maybeAlias, c.aliases, _p35._0._0._0)));
							return A2(
								_elm_lang$core$Basics_ops['++'],
								A2(
									_elm_lang$core$List$map,
					...
					case 'TypeRecord':
						return A2(
							...
							A2(_elm_lang$core$Basics_ops['++'], _p35._1, _p35._0._0));
					case 'TypeVariable':
						return A2(
							_elm_lang$core$List$map,
							function (_p42) {
								...
								return A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										': ',
										A3(_user$project$ExType$elixirT, flatten, c, _p43._1)));
							},
							_p35._1);
					case 'TypeRecordConstructor':
						return A2(
								...
								function (_p44) {
									...
									return A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											': ',
											A3(_user$project$ExType$elixirT, flatten, c, _p45._1)));
								},
								_p35._1),
							A3(_user$project$ExType$typeRecordFields, c, flatten, _p35._0));
					default:
						break _v17_4;
				}
			} else {
...
var _user$project$ExType$uniontype = F2(
	function (c, t) {
		var _p47 = t;
		if (((_p47.ctor === 'TypeConstructor') && (_p47._0.ctor === '::')) && (_p47._0._1.ctor === '[]')) {
			if (_p47._1.ctor === '[]') {
				return _user$project$Helpers$atomize(_p47._0._0);
			} else {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					'{',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Helpers$atomize(_p47._0._0),
						A2(
							_elm_lang$core$Basics_ops['++'],
							', ',
							A2(
...
var _user$project$ExType$typespec = F2(
	function (c, t) {
		var _p49 = _user$project$Helpers$lastAndRest(
			...
			return A2(
				...
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						') :: ',
						A2(_user$project$ExType$elixirTNoFlat, c, _p49._0._0))));
		} else {
			return _elm_lang$core$Native_Utils.crashCase(
				'ExType',
				{
					start: {line: 251, column: 5},
		...
		switch (_p2.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.crashCase(
					'ExExpression',
					{
						start: {line: 650, column: 5},
						end: {line: 661, column: 41}
					},
					_p2)('No such export');
		}
	});
		...
		if (_p38.ctor === '[]') {
			...
			if (_p38._1.ctor === '[]') {
				switch (_p38._0) {
					...
					default:
						var _p40 = _p38._0;
						if (_user$project$Helpers$isCapitilzed(_p40)) {
							return A2(
								_elm_lang$core$Maybe$withDefault,
								_user$project$Helpers$atomize(_p40),
								A2(
									_elm_lang$core$Maybe$map,
									_user$project$ExExpression$elixirE(c),
									A2(
										...
										_user$project$ExType$typealiasConstructor(
											{ctor: '[]'}),
										A2(_user$project$ExAlias$maybeAlias, c.aliases, _p40))));
						} else {
							if (A2(_elm_lang$core$String$startsWith, '@', _p40)) {
								return _user$project$Helpers$atomize(
									A2(_elm_lang$core$String$dropLeft, 1, _p40));
							} else {
								var _p39 = _user$project$Helpers$isOperator(_p40);
								switch (_p39.ctor) {
									case 'Builtin':
										return _elm_lang$core$Native_Utils.eq(_p40, '<|') ? 'flip.((&|>/0).())' : A2(
											_elm_lang$core$Basics_ops['++'],
											'(&',
											A2(
												_elm_lang$core$Basics_ops['++'],
												_user$project$Helpers$translateOperator(_p40),
												'/0).()'));
									case 'Custom':
										return _user$project$Helpers$translateOperator(_p40);
									default:
										return A2(_user$project$Helpers$toSnakeCase, true, _p40);
								}
							}
						}
				}
				...
				var _p42 = _p38;
				var _p41 = _user$project$Helpers$lastAndRest(_p42);
				if ((_p41.ctor === '_Tuple2') && (_p41._0.ctor === 'Just')) {
					return A2(
						_user$project$ExExpression$elixirE,
						c,
						_Bogdanp$elm_ast$Ast_Expression$Variable(
...
var _user$project$ExExpression$tupleOrFunction = F2(
	function (c, a) {
		var _p43 = _user$project$ExExpression$flattenApplication(a);
		_v38_9:
		do {
			_v38_8:
			do {
					...
					switch (_p43._0.ctor) {
						case 'Application':
							if (_p43._1.ctor === '[]') {
								return A2(
									_elm_lang$core$Basics_ops['++'],
									A2(_user$project$ExExpression$elixirE, c, _p43._0._0),
									A2(
										_elm_lang$core$Basics_ops['++'],
										'.(',
										A2(
											_elm_lang$core$Basics_ops['++'],
											A2(_user$project$ExExpression$elixirE, c, _p43._0._1),
											')')));
							} else {
								break _v38_9;
							}
						case 'Variable':
							if ((_p43._0._0.ctor === '::') && (_p43._0._0._1.ctor === '[]')) {
								switch (_p43._0._0._0) {
									case 'ffi':
										return _elm_lang$core$Native_Utils.crashCase(
											'ExExpression',
											{
									...
									case 'Just':
										if ((_p43._1.ctor === '::') && (_p43._1._1.ctor === '[]')) {
											return A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													A2(_user$project$ExExpression$elixirE, c, _p43._1._0),
													'}'));
										} else {
											break _v38_8;
										}
									case 'Ok':
										if ((_p43._1.ctor === '::') && (_p43._1._1.ctor === '[]')) {
											...
											return _elm_lang$core$Native_Utils.eq(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													A2(_user$project$ExExpression$elixirE, c, _p48),
													'}'));
										} else {
											break _v38_8;
										}
			...
			var _p56 = _p43._1;
			var _p49 = _user$project$Helpers$lastAndRest(_p43._0._0);
						...
						function (_p50) {
							return A3(
								...
								A2(
									...
									'(',
									A2(_user$project$ExExpression$elixirE, c, _p50)));
						},
						A2(
							_elm_lang$core$Maybe$andThen,
							_user$project$ExType$typealiasConstructor(
							...
							A2(
								...
								function (_p51) {
									var _p52 = _p51;
									var _p53 = _p52.aliasType;
									if (_p53.ctor === 'TypeAlias') {
										return _elm_lang$core$Maybe$Just(_p52);
									} else {
										return _elm_lang$core$Maybe$Nothing;
									}
								},
								A2(_user$project$ExAlias$maybeAlias, c.aliases, _p54)))));
			} else {
				return _elm_lang$core$Native_Utils.crashCase(
					'ExExpression',
					{
						start: {line: 427, column: 13},
						end: {line: 461, column: 52}
					},
					_p49)('Won\'t ever happen');
			}
		} while(false);
		return _elm_lang$core$Native_Utils.crashCase(
			'ExExpression',
...
var _user$project$ExExpression$resolveFfi = F2(
	function (c, ffi) {
		...
		do {
			switch (_p58.ctor) {
				case 'TryFfi':
					if ((_p58._0.ctor === 'String') && (_p58._1.ctor === 'String')) {
						if (_p58._2.ctor === 'Tuple') {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								'try_catch fn _ -> ',
								A2(
									...
									A2(
										...
										A2(
											...
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													A2(_user$project$ExExpression$combineComas, c, _p58._2),
									...
									A2(
										...
										A2(
											...
											A2(
												...
												A2(
													_elm_lang$core$Basics_ops['++'],
													A2(_user$project$ExExpression$elixirE, c, _p58._2),
													A2(_elm_lang$core$Basics_ops['++'], ')', ' end')))))));
						}
					} else {
						break _v42_7;
				...
				case 'Lffi':
					if (_p58._0.ctor === 'String') {
						if (_p58._1.ctor === 'Tuple') {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								_p58._0._0,
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										A2(_user$project$ExExpression$combineComas, c, _p58._1),
										')')));
						} else {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										A2(_user$project$ExExpression$elixirE, c, _p58._1),
										')')));
						}
					} else {
						break _v42_7;
				...
				default:
					var args = _user$project$Helpers$generateArguments(_p58._0);
					return A2(
						_elm_lang$core$Basics_ops['++'],
						'fn (',
						A2(
												...
												A2(
													...
													A2(
														...
														A2(
															...
															'end')))))))))));
			case 'Builtin':
				if (((_p60._1.ctor === '::') && (_p60._1._1.ctor === '::')) && (_p60._1._1._1.ctor === '[]')) {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						_user$project$Helpers$ind(c.indent),
						A2(
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										A2(_user$project$ExExpression$elixirE, c, _p60._1._0),
										A2(
											_elm_lang$core$Basics_ops['++'],
											' ',
											A2(
												...
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														A2(_user$project$ExExpression$elixirE, c, _p60._1._1._0),
														A2(
															_elm_lang$core$Basics_ops['++'],
															' do',
															A2(
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'ExExpression',
						{
							start: {line: 592, column: 5},
							end: {line: 645, column: 25}
						},
						_p60)(
						A2(
							_elm_lang$core$Basics_ops['++'],
					...
					if (_p66.ctor === '[]') {
						...
						if (_p66._1.ctor === '[]') {
							return A2(
								_elm_lang$core$Basics_ops['++'],
								'a',
								_elm_lang$core$Basics$toString(_p68));
						} else {
							return A2(
								...
								A2(
									...
									_elm_lang$core$List$length(_p66) - 1,
									_Bogdanp$elm_ast$Ast_Expression$Variable(
										{
											ctor: '::',
											_0: A2(
			...
			if (_p69.ctor === '_Tuple2') {
				if (_p69._0.ctor === 'Nothing') {
					return _elm_lang$core$Native_Utils.crashCase(
						...
						_p69)('Ffi requires type definition');
				} else {
					if (((((((((_p69._1.ctor === '::') && (_p69._1._0.ctor === 'Variable')) && (_p69._1._0._0.ctor === '::')) && (_p69._1._0._0._1.ctor === '[]')) && (_p69._1._1.ctor === '::')) && (_p69._1._1._0.ctor === 'String')) && (_p69._1._1._1.ctor === '::')) && (_p69._1._1._1._0.ctor === 'String')) && (_p69._1._1._1._1.ctor === '[]')) {
						switch (_p69._1._0._0._0) {
							case 'ffi':
								var _p73 = _p69._1._1._0._0;
								var _p72 = _p69._1._1._1._0._0;
								var _p71 = _p69._0._0;
								return A2(
									_elm_lang$core$Basics_ops['++'],
									A3(_user$project$ExExpression$functionCurry, c, name, _p71.arity),
									A2(
										_elm_lang$core$Basics_ops['++'],
										A4(
														...
														A2(
															...
															A2(
																...
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	'/',
																	_elm_lang$core$Basics$toString(_p71.arity)))))))),
										A2(
											_elm_lang$core$Basics_ops['++'],
											_user$project$Helpers$ind(c.indent),
											A2(
													...
													A2(
														...
														A2(
															...
															A2(
																_elm_lang$core$String$join,
																', ',
																A2(_user$project$Helpers$generateArguments_, 'a', _p71.arity)),
															A2(
																_elm_lang$core$Basics_ops['++'],
																')',
																A2(
							...
							case 'tryFfi':
								...
								return A2(
									_elm_lang$core$Basics_ops['++'],
									A3(_user$project$ExExpression$functionCurry, c, name, _p74.arity),
									A2(
										_elm_lang$core$Basics_ops['++'],
										_user$project$Helpers$ind(c.indent),
										A2(
												...
												A2(
													...
													A2(
														...
														A2(
															_elm_lang$core$String$join,
															', ',
															A2(_user$project$Helpers$generateArguments_, 'a', _p74.arity)),
														A2(
															_elm_lang$core$Basics_ops['++'],
															')',
															A2(
